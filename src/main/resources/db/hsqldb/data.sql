...
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000001', 'Leo', '2010-09-07', '20000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001'); -- Leo (cat) / George Franklin
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000002', 'Basil', '2012-08-06', '20000000-0000-0000-0000-000000000006', '30000000-0000-0000-0000-000000000002'); -- Basil (hamster) / Betty Davis
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000003', 'Rosy', '2011-04-17', '20000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000003'); -- Rosy (dog) / Eduardo Rodriquez
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000004', 'Jewel', '2010-03-07', '20000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000003'); -- Jewel (dog) / Eduardo Rodriquez
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000005', 'Iggy', '2010-11-30', '20000000-0000-0000-0000-000000000003', '30000000-0000-0000-0000-000000000004'); -- Iggy (lizard) / Harold Davis
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000006', 'George', '2010-01-20', '20000000-0000-0000-0000-000000000004', '30000000-0000-0000-0000-000000000005'); -- George (snake) / Peter McTavish
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000007', 'Samantha', '2012-09-04', '20000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000006'); -- Samantha (cat) / Jean Coleman
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000008', 'Max', '2012-09-04', '20000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000006'); -- Max (cat) / Jean Coleman
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000009', 'Lucky', '2011-08-06', '20000000-0000-0000-0000-000000000005', '30000000-0000-0000-0000-000000000007'); -- Lucky (bird) / Jeff Black
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000010', 'Mulligan', '2007-02-24', '20000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000008'); -- Mulligan (dog) / Maria Escobito
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000011', 'Freddy', '2010-03-09', '20000000-0000-0000-0000-000000000005', '30000000-0000-0000-0000-000000000009'); -- Freddy (bird) / David Schroeder
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000012', 'Lucky', '2010-06-24', '20000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000010'); -- Lucky (dog) / Carlos Estaban
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES ('40000000-0000-0000-0000-000000000013', 'Sly', '2012-06-08', '20000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000010'); -- Sly (cat) / Carlos Estaban

-- Visits (Using predefined UUIDs and linking to pet UUIDs)
INSERT INTO visits (id, pet_id, visit_date, description) VALUES ('50000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000007', '2013-01-01', 'rabies shot'); -- Samantha
INSERT INTO visits (id, pet_id, visit_date, description) VALUES ('50000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000008', '2013-01-02', 'rabies shot'); -- Max
INSERT INTO visits (id, pet_id, visit_date, description) VALUES ('50000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000008', '2013-01-03', 'neutered'); -- Max
INSERT INTO visits (id, pet_id, visit_date, description) VALUES ('50000000-0000-0000-0000-000000000004', '40000000-0000-0000-0000-000000000007', '2013-01-04', 'spayed'); -- Samantha
