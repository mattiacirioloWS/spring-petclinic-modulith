...
@Command
class CreateOwnerImpl implements CreateOwner {

	private final OwnerRepository ownerRepository;

	CreateOwnerImpl(OwnerRepository ownerRepository) {
		this.ownerRepository = ownerRepository;
	}

	@Override
	public OwnerDto execute(OwnerDto owner) {
		return OwnerDto.from(ownerRepository.save(Owner.create(owner.getFirstName(), owner.getLastName(),
