 ...
 * @author Wick Dynex
 */
interface JpaPetRepository extends JpaRepository<PetEntity, UUID> {
	...
	Optional<PetEntity> findByNameAndOwnerId(String name, UUID ownerId);

	List<PetEntity> findByOwnerId(UUID ownerId);

	Boolean existsByIdAndOwnerId(UUID petId, UUID ownerId);
